  ...
  case "$(uname)" in
    Linux*)
      if command -v xdg-open > /dev/null; then
        ...
        echo "xdg-open not found. Please open the URL manually: $REPO_URL"
      fi
      ;;
    Darwin*)
      if command -v open > /dev/null; then
        ...
        echo "open command not found. Please open the URL manually: $REPO_URL"
      fi
      ;;
    CYGWIN*|MINGW32*|MSYS*|MINGW*)
      if command -v start > /dev/null; then
        ...
        echo "start command not found. Please open the URL manually: $REPO_URL"
      fi
      ;;
    *)
      echo "Unknown operating system. Please open the URL manually: $REPO_URL"
      ;;
  esac
}
# }}}
